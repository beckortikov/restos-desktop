...
const PULL_TABLES = [
  ...
  'ingredients', 'financial_accounts', 'custom_categories', 'menu_categories', 'modifier_groups', 'modifiers',
...
const PUSH_TABLES = [
  ...
  'financial_accounts', 'custom_categories', 'menu_categories', 'modifier_groups', 'modifiers',
  'semi_finished_types', 'semi_recipe_lines', 'semi_finished_stock',
  'assets', 'liabilities', 'equity_entries', 'budget_lines',
